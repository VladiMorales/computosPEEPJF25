...
class Jd extends Component
{
    ...
    {
        $this->boletas=ModelsJD::where('casilla', $this->casilla)->get()->count();
        return view('livewire.jd');
    }
}
