...
<head>
    ...
    <title>SS</title>
    <link rel="stylesheet" href="{{asset("css/bSS.css")}}">
    <link rel="stylesheet" href="{{asset("css/tablas.css")}}">
</head>
<body>
    <h1>MAGISTRADAS Y MAGISTRADOS DE LA SALA SUPERIOR DEL TRIBUNAL ELECTORAL DEL PODER JUDICIAL DE LA FEDERACIÓN</h1>
