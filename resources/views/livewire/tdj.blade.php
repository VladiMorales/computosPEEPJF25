 <div>
    ...
    <form wire:submit.prevent='capturaTDJ'>
        <div class="alinear">
            <div class="check">  
                <label for="opciones">Tipo de Boleta:</label>    
            
                <select id="tipoBoleta" onchange="desInputTDJ()" id="tipoBoleta" class="opciones tamaño" wire:model='tipoB' @if($isDisabled) disabled @endif>
